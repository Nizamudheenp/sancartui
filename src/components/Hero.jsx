...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-[100dvh] flex flex-col justify-between pt-28 sm:pt-36 pb-16 sm:pb-12 overflow-hidden bg-transparent">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full flex-grow flex flex-col justify-center items-center relative z-10">
        ...
        <div className="text-center">
          <h1 className="text-5xl sm:text-7xl lg:text-9xl font-serif font-light text-gray-900 leading-[1.05] tracking-tight max-w-5xl drop-shadow-sm">
            Your Finds <br />
            <span className="inline-block pr-3 sm:pr-4 font-sans font-extrabold italic text-brand-gradient">in Safe Hands</span>
          </h1>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full z-10 flex justify-center sm:justify-start pb-6 sm:pb-0">
        <div
          onClick={handleClick}
