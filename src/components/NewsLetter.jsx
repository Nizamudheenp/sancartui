        ...
        {subscribed ? (
          ...
          <form onSubmit={handleSubscribe} className="relative flex items-center w-full">
            <input
              ...
              className="w-full pl-5 pr-32 py-4 border border-white/60 rounded-2xl focus:ring-2 focus:ring-blue-600/10 focus:border-[#1b36e3] focus:outline-none transition-all text-sm text-slate-800 placeholder-slate-400 bg-white/40 backdrop-blur-sm font-medium"
              required
            />
            <button 
              type="submit" 
