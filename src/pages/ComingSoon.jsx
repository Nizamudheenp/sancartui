...
const ComingSoon = () => {
  return (
    <div className="relative text-center flex flex-col items-center justify-center min-h-[85vh] px-6 pt-28 overflow-hidden">
      ...
      <div className="relative z-10 max-w-md bg-white/30 backdrop-blur-md rounded-[2.5rem] p-10 border border-white/50 shadow-glass flex flex-col items-center">
        ...
        <p className="mb-8 text-sm text-gray-600 font-semibold leading-relaxed">
